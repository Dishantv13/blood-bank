...
const BloodBankForgotPassword = lazy(
  () => import("./pages/BloodBankForgotPassword"),
);
const BloodBankResetPassword = lazy(
  () => import("./pages/BloodBankResetPassword"),
);
const ChangePassword = lazy(() => import("./pages/ChangePassword"));
const BloodBankChangePassword = lazy(
  () => import("./pages/BloodBankChangePassword"),
);
const BloodBankDirectoryDetails = lazy(
  () => import("./pages/BloodBankDirectoryDetails"),
);
const BloodBankPublicDetails = lazy(
  () => import("./pages/BloodBankPublicDetails"),
);
const DonationHistory = lazy(() => import("./pages/DonationHistory"));
const VerifyCertificate = lazy(() => import("./pages/VerifyCertificate"));
const BloodBankUnitTracking = lazy(
  () => import("./pages/BloodBankUnitTracking"),
);
...
const AdminBloodBankDetails = lazy(
  () => import("./adminPage/AdminBloodBankDetails"),
);
const AdminCamps = lazy(() => import("./adminPage/AdminCamps"));
const AdminCampsByBloodBank = lazy(
  () => import("./adminPage/AdminCampsByBloodBank"),
);
const AdminEvents = lazy(() => import("./adminPage/AdminEvents"));
const AdminEventsByBloodBank = lazy(
  () => import("./adminPage/AdminEventsByBloodBank"),
);
const AdminRequests = lazy(() => import("./adminPage/AdminRequests"));
const AdminRequestsByUser = lazy(
  () => import("./adminPage/AdminRequestsByUser"),
);
const AdminDonations = lazy(() => import("./adminPage/AdminDonations"));
const AdminDonationsByUser = lazy(
  () => import("./adminPage/AdminDonationsByUser"),
);
const AdminInventory = lazy(() => import("./adminPage/AdminInventory"));
const AdminInventoryDetails = lazy(
  () => import("./adminPage/AdminInventoryDetails"),
);
                  ...
                  <ErrorBoundary>
                    <Suspense fallback={<SkeletonLoader />}>
                      <Routes>
                        {/* Blood Bank Routes */}
                        <Route
                          path={ROUTE_PATH.BLOOD_BANK_LOGIN}
                        ...
                        >
                          ...
                          />
                          <Route
                            path={ROUTE_PATH.ADMIN_BLOOD_BANK_DETAILS}
                            element={<AdminBloodBankDetails />}
                          />
                          <Route
                          ...
                          />
                          <Route
                            path={ROUTE_PATH.ADMIN_CAMPS_BY_BANK}
                            element={<AdminCampsByBloodBank />}
                          />
                          <Route
                          ...
                          />
                          <Route
                            path={ROUTE_PATH.ADMIN_EVENTS_BY_BANK}
                            element={<AdminEventsByBloodBank />}
                          />
                          <Route
                          ...
                          />
                          <Route
                            path={ROUTE_PATH.ADMIN_REQUESTS_BY_USER}
                            element={<AdminRequestsByUser />}
                          />
                          <Route
                          ...
                          />
                          <Route
                            path={ROUTE_PATH.ADMIN_DONATIONS_BY_USER}
                            element={<AdminDonationsByUser />}
                          />
                          <Route
                          ...
                          />
                          <Route
                            path={ROUTE_PATH.ADMIN_INVENTORY_DETAILS}
                        ...
                        <Route path={ROUTE_PATH.HOME} element={<Login />} />
                        ...
                        <Route
                          path={ROUTE_PATH.VERIFY_CERTIFICATE}
