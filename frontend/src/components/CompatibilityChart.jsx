const CompatibilityChart = ({ bloodGroup }) => {
  ...
  return (
    <div className="compatibility-guide-card">
      <h4 className="guide-title">Compatibility Guide for {bloodGroup}</h4>
      ...
      <p className="guide-disclaimer">
        *Compatibility is based on general medical rules. Specific
        cross-matching in a lab is always required before transfusion.
      </p>
    </div>
  );
};
