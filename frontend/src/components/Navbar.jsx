            ...
            >
              ...
              {user?.activeMode === "donor" && user?.isDonor && (
                <>
                  ...
                  <li>
                    <NavLink
                      to={ROUTE_PATH.DONATION_HISTORY}
                      className={getNavLinkClass}
                    >
                      Donation History
                    </NavLink>
        ...
        <div className="navbar-actions">
                ...
                {showDropdown && (
                  <>
                    ...
                    <div className="dropdown-menu">
                      ...
                      <Link
                        to={ROUTE_PATH.BLOOD_BANK_LOGIN}
                        className="dropdown-item"
                        onClick={() => setShowDropdown(false)}
                      >
                        <svg
          ...
          {!isAuthenticated && (
            ...
            >
              <Link
                to={ROUTE_PATH.LOGIN}
                className="btn btn-outline navbar-btn login-btn"
              >
                Login
              </Link>
              <Link
                to={ROUTE_PATH.BLOOD_BANK_REGISTER}
                className="btn btn-primary navbar-btn register-btn"
              >
                Register
              </Link>
            </div>
