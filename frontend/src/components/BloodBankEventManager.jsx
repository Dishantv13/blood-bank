...
const BloodBankEventManager = () => {
  ...
  const handleExportRegistrations = async (eventId) => {
    try {
      ...
      error(
        "Failed to export registrations: " + (err.data?.message || err.message),
      );
    }
  };
  ...
  return (
    <div className="event-manager-container">
      ...
      <div className="event-stats">
        ...
        <div className="stat-card2">
          <div className="stat-value1">{upcomingRegistrations}</div>
            ...
            <div className="camp-details-content">
              <div className="detail-section">
                ...
                <div className="detail-row">
                  ...
                  <span>
                    {new Date(selectedEventForDetails.date).toLocaleDateString(
                      "en-US",
                      {
                        weekday: "long",
                        year: "numeric",
                ...
                <div className="detail-row">
                  ...
                  <span>
                    {selectedEventForDetails.startTime || "09:00"} -{" "}
                    {selectedEventForDetails.endTime || "17:00"}
                  </span>
                </div>
                <div className="detail-row">
                  <span className="detail-label">Type:</span>
                  <span style={{ textTransform: "capitalize" }}>
                    {(selectedEventForDetails.eventType || "").replace(
                      /-/g,
                      " ",
                    )}
                  </span>
                ...
                <div className="detail-row">
                  ...
                  <span
                    className={`camp-status ${new Date(selectedEventForDetails.date) >= today ? "scheduled" : "completed"}`}
                  >
                    {new Date(selectedEventForDetails.date) >= today
                      ? "Upcoming"
                      : "Past"}
                  </span>
                </div>
                <div className="detail-row">
                  ...
                  <span style={{ textTransform: "capitalize" }}>
                    {selectedEventForDetails.visibility || "Public"}
                  </span>
                </div>
              </div>
              ...
              <div className="detail-section">
                ...
                <div className="detail-row">
                  ...
                  <span>
                    {selectedEventForDetails.maxParticipants || "Unlimited"}
                  </span>
                </div>
                <div className="detail-row">
                  <span className="detail-label">Registered:</span>
                  <span>
                    {selectedEventForDetails.registeredDonors?.length || 0}
                  </span>
                </div>
                  ...
                  <>
                    <div className="progress-bar-large">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, ((selectedEventForDetails.registeredDonors?.length || 0) / selectedEventForDetails.maxParticipants) * 100)}%`,
                        }}
                      ></div>
                    </div>
                    <div className="progress-percentage">
                      {Math.round(
                        ((selectedEventForDetails.registeredDonors?.length ||
                          0) /
                          selectedEventForDetails.maxParticipants) *
                          100,
                      )}
                ...
                <>
                  ...
                  <div className="modal-footer">
                    <button
                      ...
                      onClick={() =>
                        handleExportRegistrations(selectedEvent._id)
                      }
                    >
                      <svg
                        viewBox="0 0 24 24"
