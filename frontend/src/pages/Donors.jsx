        ...
        {donors.length === 0 ? (
          ...
          donors.map((donor) => {
            ...
            const nextEligibleDate = lastDonation
              ? new Date(
                  new Date(lastDonation).setMonth(
                    new Date(lastDonation).getMonth() + 3,
                  ),
                )
              : null;
              ...
              <div key={donor._id} className="donor-card-modern">
                ...
                {availabilityTab === "recently" && lastDonation && (
                  <div className="donor-status-badge recently-donated">
                    <span>
                      Available again: {nextEligibleDate?.toLocaleDateString()}
                    </span>
                  </div>
                )}
                ...
                <div
                  className={`donor-image-section ${donorPhotos[donor._id] ? "has-photo" : ""}`}
                >
                  {donorPhotos[donor._id] ? (
                    ...
                    <div className="donor-profile-image">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M40 180C40 140 65 120 100 120C135 120 160 140 160 180"
                          stroke="white"
                          strokeWidth="4"
                          strokeLinecap="round"
                          opacity="0.8"
                ...
                <div className="donor-content-section">
                  ...
                  <p className="donor-card-description">
                    {donor.isDonor
                      ? "Verified blood donor committed to saving lives through regular donations"
                      : "Active donor ready to help in emergencies"}
                  </p>
                  ...
                  <div className="donor-card-stats">
                    <div className="stat-item-card">
                      ...
                      <span className="stat-value">
                        {donor.donorInfo?.totalDonations ||
                    ...
                    <div className="stat-item-card">
                      ...
                      <span className="stat-value">
                        {donor.donorInfo?.eventsAttended ||
                          donor.eventsAttended ||
                          0}
                      </span>
                    </div>

                    <span className="blood-group-badge-card">
                      {donor.bloodGroup}
                    </span>
              ...
              <div className="contact-modal-header">
                <div className="contact-avatar">
                  {donorPhotos[selectedDonor._id] ? (
                    <img
                      src={donorPhotos[selectedDonor._id]}
                ...
                <span className="contact-blood-badge">
