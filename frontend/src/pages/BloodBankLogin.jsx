  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bloodBankProfile =
        response?.bloodBank || response?.data?.bloodBank || null;
      if (bloodBankProfile) {
      ...
      <div className="blood-bank-auth-container">
        <div className="auth-left-panel">
          <div className="auth-branding">
            ...
            <p>
              Manage your blood bank inventory, organize camps, and save lives
            </p>
          </div>
        ...
        <div className="auth-right-panel">
          <div className="auth-form-container">
            <div className="auth-form-header">
              <h2>Welcome Back</h2>
              <p>
                Sign in after your blood bank registration has been approved by
                admin
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="form-options">
                ...
                <Link
                  to={ROUTE_PATH.BLOOD_BANK_FORGOT_PASSWORD}
            ...
            <div className="auth-footer">
              <p>
                ...
                <Link to={ROUTE_PATH.BLOOD_BANK_REGISTER}>
