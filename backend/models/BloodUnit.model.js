...
const BloodUnitSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['raw', 'quarantine', 'available', 'reserved', 'used', 'expired', 'discarded', 'processed'],
    default: 'raw',
    index: true
  },
  collectionDate: {
  ...
  screeningResults: {
    ...
    hbv: { type: String, enum: ['negative', 'positive', 'pending'], default: 'pending' },
  ...
  crossMatch: {
    ...
    recipientRequest: { type: mongoose.Schema.Types.ObjectId, ref: 'BloodRequest' },
    matchedAt: Date,
    matchedBy: String
  },
  discardDetails: {
