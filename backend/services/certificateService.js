...
export const generateDonationCertificate = async (donation) => {
  ...
  const bloodBankName =
    donation.bloodBank?.name || donation.camp?.name || "Authorized Blood Bank";
    ...
    try {
      ...
      try {
        ...
        doc
          ...
          .fontSize(100)
          .font("Helvetica-Bold")
          .text("RAKTSARTHI", 0, pageHeight / 2 - 50, { align: "center" });
      }
      doc.restore();
      ...
      doc
        ...
        .fontSize(14)
        .font("Helvetica-Bold")
        .text("RAKTSARTHI BLOOD BANK NETWORK", 0, 145, {
          align: "center",
          characterSpacing: 2,
        });
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          "National Certified Donor Registry | ISO 9001:2015 Certified",
          0,
          165,
          {
            align: "center",
      ...
      doc
        ...
        .fontSize(18)
        .font("Helvetica")
        .text("OF NOBLE CONTRIBUTION", 0, 240, {
          align: "center",
          characterSpacing: 3,
        });
      ...
      doc
        ...
        .fontSize(14)
        .font("Helvetica")
        .text("This proud recognition is awarded to", 0, 285, {
          align: "center",
        });
      ...
      doc
        .moveTo(pageWidth / 2 - 120, 355)
        .lineTo(pageWidth / 2 + 120, 355)
        .lineWidth(1.5)
        .strokeColor("#d4af37")
        .stroke();
      ...
      const drawDetail = (label, value, x) => {
        ...
        doc
          ...
          .fontSize(13)
          .font("Helvetica-Bold")
          .text(value, x, detailsY + 12, { width: colWidth, align: "center" });
      };
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          `Certificate Hash: ${hash} | Digitally Issued on ${new Date().toLocaleString()}`,
          0,
          footerY + 8,
          { align: "center" },
        );
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .text(
          "THE BLOOD OF A HERO FLOWS THROUGH THE VEINS OF A SURVIVOR",
          0,
          footerY - 18,
          {
            align: "center",
